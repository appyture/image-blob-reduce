...
var require_pica = __commonJS({
  "node_modules/.pnpm/pica@9.0.1/node_modules/pica/dist/pica.js"(exports, module) {
    (function(f) {
...
// lib/image_traverse.js
var require_image_traverse = __commonJS({
  "lib/image_traverse.js"(exports, module) {
    "use strict";
...
// lib/jpeg_plugins.js
var require_jpeg_plugins = __commonJS({
  "lib/jpeg_plugins.js"(exports, module) {
    "use strict";
    var image_traverse = require_image_traverse();
...
// index.js
var require_image_blob_reduce = __commonJS({
  "index.js"(exports, module) {
    ...
    ImageBlobReduce.prototype.init = function() {
      this.use(require_jpeg_plugins().assign);
    };
...
export default require_image_blob_reduce();
